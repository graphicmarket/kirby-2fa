  ...
  <div>
    ...
    <k-dialog ref="enableDialog" size="medium">
      <template v-if="auth">
        ...
        <k-text class="mg-b-md">Please scan the QR code:</k-text>
        <img :src="auth.qr" class="mg-b-md" width="100" alt />
        <k-text
          class="mg-b-lg"
        >After scanning de QR, please copy and paste the code that the authentication application shows to you.</k-text>
        <k-text-field v-model="code" class="mg-b-md" name="code" label="Insert the code"></k-text-field>
